/*
Now that we know the algorithm for the operations append, prepend, insert and delete we can write the logic as follows.

Along with the operations, we will add printList for logging the values for each node in the doubly linked list.
*/
